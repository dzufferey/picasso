...
class DiGraphSuite extends FunSuite {
  ...
  test("SCC"){
    val emptyDG = DiGraph.empty[UIGT]
    val dg1 = emptyDG ++ 
        (N(0) --> 9) ++ (N(0) --> 21) ++ (N(0) --> 19) ++ (N(0) --> 17) ++ (N(1) --> 10) ++
        (N(1) --> 12) ++ (N(3) --> 26) ++ (N(3) --> 16) ++ (N(3) --> 28) ++ (N(3) --> 17) ++
        (N(4) --> 26) ++ (N(4) --> 16) ++ (N(4) --> 28) ++ (N(4) --> 17) ++ (N(5) --> 21) ++
        (N(5) --> 19) ++ (N(5) --> 17) ++ (N(6) --> 20) ++ (N(7) --> 6) ++ (N(7) --> 14) ++
        (N(8) --> 5) ++ (N(8) --> 21) ++ (N(10) --> 6) ++ (N(10) --> 11) ++ (N(10) --> 12) ++
        (N(11) --> 20) ++ (N(12) --> 7) ++ (N(13) --> 28) ++ (N(13) --> 21) ++ (N(13) --> 19) ++
        (N(13) --> 17) ++ (N(14) --> 23) ++ (N(14) --> 2) ++ (N(15) --> 25) ++ (N(16) --> 3) ++ 
        (N(17) --> 0) ++ (N(19) --> 22) ++ (N(20) --> 16) ++ (N(20) --> 8) ++ (N(21) --> 13) ++
        (N(22) --> 27) ++ (N(24) --> 26) ++ (N(24) --> 16) ++ (N(24) --> 28) ++ (N(24) --> 17) ++
        (N(25) --> 1) ++ (N(26) --> 4) ++ (N(27) --> 23) ++ (N(27) --> 18) ++ (N(28) --> 24)
    assert(dg1.SCC(true).size == 20, dg1.SCC(true))
